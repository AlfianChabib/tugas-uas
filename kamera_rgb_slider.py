...
class HilalObservationApp:
    def __init__(self, root):
        ...
        # Slider untuk batas RGB (Postprocessing)
        self.r_min = tk.Scale(self.root, from_=0, to=255, orient="horizontal", label="R Min")
        self.r_min.set(0)
        self.r_min.pack()
        self.r_max = tk.Scale(self.root, from_=0, to=255, orient="horizontal", label="R Max")
        self.r_max.set(255)
        self.r_max.pack()

        self.g_min = tk.Scale(self.root, from_=0, to=255, orient="horizontal", label="G Min")
        self.g_min.set(0)
        self.g_min.pack()
        self.g_max = tk.Scale(self.root, from_=0, to=255, orient="horizontal", label="G Max")
        self.g_max.set(255)
        self.g_max.pack()

        self.b_min = tk.Scale(self.root, from_=0, to=255, orient="horizontal", label="B Min")
        self.b_min.set(0)
        self.b_min.pack()
        self.b_max = tk.Scale(self.root, from_=0, to=255, orient="horizontal", label="B Max")
        self.b_max.set(255)
        self.b_max.pack()
